package com.divinetechs.ebooksapp.Mpesa;
...
import com.divinetechs.ebooksapp.Activity.AllPaymentActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        daraja = Daraja.with("lpRnSFJyeMPnJ90yO0pOG8grwRuDm3il", "0OTXfudvr2xzLb1Y", new DarajaListener<AccessToken>() {
            ...
            public void onResult(@NonNull AccessToken accessToken) {
                Log.i(com.divinetechs.ebooksapp.Mpesa.Payment.this.getClass().getSimpleName(), accessToken.getAccess_token());
            }

            @Override
            public void onError(String error) {
                Log.e(com.divinetechs.ebooksapp.Mpesa.Payment.this.getClass().getSimpleName(), error);
            ...
            daraja.requestMPESAExpress(lnmExpress,
                    new DarajaListener<LNMResult>() {
                        ...
                        public void onResult(@NonNull LNMResult lnmResult) {
                            Log.i(com.divinetechs.ebooksapp.Mpesa.Payment.this.getClass().getSimpleName(), lnmResult.ResponseDescription);
                        ...
                        @Override
                        public void onError(String error) {
                            Log.i(com.divinetechs.ebooksapp.Mpesa.Payment.this.getClass().getSimpleName(), error);
                        }
                    }
            );
        }
